  ...
  <div style="height: 100%">
    ...
    <div style="height: 100%">
        ...
        <div class="TabelaBaixo">
            ...
            <NewOrder :order="Invoice" :general="general" @message="message" v-if="form_faturacao === 'NovaFatura'" @CancelarFatura="titulo('Ordens')"/>
            ...
            <invoice v-if="print" @CloseModal="print = false" :general="general" :order="Invoice"/>
        </div>
    </div>
  </div>
</template>
