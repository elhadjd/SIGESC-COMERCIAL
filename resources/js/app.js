...
import { faArrowDown, faArrowsSplitUpAndLeft, faArrowUpRightFromSquare, faCartShopping, faChartGantt, faChartLine, faDeleteLeft, faDownLong, faEye, faFloppyDisk, faHandHoldingDollar, faMoneyBill1Wave, faMoneyCheckDollar, faOutdent, faPenToSquare, faPlus, faReceipt, faRightLong, faRotateRight, faSackDollar, faStar, faTags, faTrash, faUpLong, faUsers, faXmark } from '@fortawesome/free-solid-svg-icons';
import { library } from '@fortawesome/fontawesome-svg-core';
import general from './mixins/general.js';
library.add(faTwitter,faDeleteLeft,faUpLong,faRotateRight,faRightLong,faChartLine,faDownLong,faChartGantt,faArrowsSplitUpAndLeft,faArrowUpRightFromSquare,faStar,faCartShopping,faProductHunt,faMoneyCheckDollar,faPlus,faUsers,faPenToSquare,faEye,faSackDollar,faMoneyBill1Wave,faHandHoldingDollar,faTrash,faFloppyDisk,faOutdent,faTags,
