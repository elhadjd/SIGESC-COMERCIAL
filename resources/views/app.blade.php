...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-339234288"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-339234288'); </script>
        <!-- Scripts -->
        @routes
